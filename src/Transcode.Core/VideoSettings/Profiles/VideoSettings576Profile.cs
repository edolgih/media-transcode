    ...
    public static VideoSettingsProfile Create()
    {
        return new VideoSettingsProfile(
            ...
            [
                ...
                new VideoSettingsDefaults("mult", "high", Cq: 22, Maxrate: 3.7m, Bufsize: 7.4m, Algorithm: FfmpegScaleAlgorithms.Bilinear, CqMin: 18, CqMax: 31, MaxrateMin: 2.3m, MaxrateMax: 5.0m),
                new VideoSettingsDefaults("mult", "default", Cq: 24, Maxrate: 3.3m, Bufsize: 6.6m, Algorithm: FfmpegScaleAlgorithms.Bilinear, CqMin: 20, CqMax: 33, MaxrateMin: 1.9m, MaxrateMax: 4.2m),
                new VideoSettingsDefaults("mult", "low", Cq: 28, Maxrate: 2.5m, Bufsize: 5.0m, Algorithm: FfmpegScaleAlgorithms.Bilinear, CqMin: 22, CqMax: 36, MaxrateMin: 1.4m, MaxrateMax: 3.2m),
                new VideoSettingsDefaults("film", "high", Cq: 21, Maxrate: 4.3m, Bufsize: 8.6m, Algorithm: FfmpegScaleAlgorithms.Bilinear, CqMin: 16, CqMax: 33, MaxrateMin: 2.0m, MaxrateMax: 8.0m),
                new VideoSettingsDefaults("film", "default", Cq: 23, Maxrate: 3.8m, Bufsize: 7.6m, Algorithm: FfmpegScaleAlgorithms.Bilinear, CqMin: 18, CqMax: 35, MaxrateMin: 1.6m, MaxrateMax: 8.0m),
                new VideoSettingsDefaults("film", "low", Cq: 27, Maxrate: 2.8m, Bufsize: 5.6m, Algorithm: FfmpegScaleAlgorithms.Bilinear, CqMin: 20, CqMax: 38, MaxrateMin: 1.2m, MaxrateMax: 4.0m)
            ]);
    }
}

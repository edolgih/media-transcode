    ...
    public static VideoSettingsProfile Create()
    {
        return new VideoSettingsProfile(
            ...
            [
                ...
                new VideoSettingsDefaults("mult", "high", Cq: 23, Maxrate: 3.2m, Bufsize: 6.4m, Algorithm: FfmpegScaleAlgorithms.Bilinear, CqMin: 19, CqMax: 32, MaxrateMin: 2.0m, MaxrateMax: 4.2m),
                new VideoSettingsDefaults("mult", "default", Cq: 24, Maxrate: 2.8m, Bufsize: 5.6m, Algorithm: FfmpegScaleAlgorithms.Bilinear, CqMin: 20, CqMax: 34, MaxrateMin: 1.7m, MaxrateMax: 3.6m),
                new VideoSettingsDefaults("mult", "low", Cq: 29, Maxrate: 2.1m, Bufsize: 4.2m, Algorithm: FfmpegScaleAlgorithms.Bilinear, CqMin: 22, CqMax: 37, MaxrateMin: 1.3m, MaxrateMax: 2.8m),
                new VideoSettingsDefaults("film", "high", Cq: 22, Maxrate: 3.4m, Bufsize: 6.8m, Algorithm: FfmpegScaleAlgorithms.Bilinear, CqMin: 17, CqMax: 34, MaxrateMin: 1.5m, MaxrateMax: 6.0m),
                new VideoSettingsDefaults("film", "default", Cq: 23, Maxrate: 3.1m, Bufsize: 6.2m, Algorithm: FfmpegScaleAlgorithms.Bilinear, CqMin: 19, CqMax: 36, MaxrateMin: 1.2m, MaxrateMax: 6.0m),
                new VideoSettingsDefaults("film", "low", Cq: 28, Maxrate: 2.2m, Bufsize: 4.4m, Algorithm: FfmpegScaleAlgorithms.Bilinear, CqMin: 21, CqMax: 39, MaxrateMin: 0.9m, MaxrateMax: 3.0m)
            ]);
    }
}

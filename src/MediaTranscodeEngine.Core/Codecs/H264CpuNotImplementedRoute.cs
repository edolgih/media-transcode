...
public sealed class H264CpuNotImplementedRoute : ITranscodeRoute
{
    public bool CanHandle(TranscodeRequest request)
    {
        ArgumentNullException.ThrowIfNull(request);
        return request.ComputeMode.Equals(RequestContracts.General.CpuComputeMode, StringComparison.OrdinalIgnoreCase);
    }
